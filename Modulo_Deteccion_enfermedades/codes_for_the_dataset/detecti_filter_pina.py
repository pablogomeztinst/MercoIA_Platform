...
def segment_image(predictor, image_path, out_dir, discarded_dir=None):
    ...
    for i in keep:
        ...
        if main_blob_ratio(mask) < MIN_MAIN_BLOB_RATIO:
            reason = "fragmentada"
...
if __name__ == "__main__":
    ...
    INPUT = "/home/joseph/Documents/MERCOIA/Algorithm/Our_dataset/Pinas/Original"

    OUT_DIR = REPO_ROOT / "Our_dataset" / "Pinas" / "Seleccionadas"
    DESCARTE = REPO_ROOT / "Our_dataset" / "Pinas" / "Descartadas"
    ...
    print(f"{n} piñas segmentadas en {OUT_DIR}")
    print(f"descartadas (fragmentada/ocluida) en {DESCARTE}")
